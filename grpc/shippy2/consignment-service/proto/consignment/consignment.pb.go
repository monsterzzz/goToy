...
type ShippingServiceClient interface {
	...
	GetAllConsignments(ctx context.Context, in *GetAllReq, opts ...client.CallOption) (*Response, error)
}
...
func (c *shippingServiceClient) GetAllConsignments(ctx context.Context, in *GetAllReq, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.serviceName, "ShippingService.GetAllConsignments", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (h *ShippingService) GetAllConsignments(ctx context.Context, in *GetAllReq, out *Response) error {
