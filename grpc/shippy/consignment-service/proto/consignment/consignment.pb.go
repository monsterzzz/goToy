...
func init() {
	...
	proto.RegisterType((*GetAllReq)(nil), "consignment.GetAllReq")
}
...
var fileDescriptor_e5e5ab05dfa973d5 = []byte{
	...
	,
}
...
type ShippingServiceClient interface {
	...
	GetAllConsignments(ctx context.Context, in *GetAllReq, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *shippingServiceClient) GetAllConsignments(ctx context.Context, in *GetAllReq, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/consignment.ShippingService/GetAllConsignments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShippingServiceServer interface {
	...
	GetAllConsignments(context.Context, *GetAllReq) (*Response, error)
}
...
func (*UnimplementedShippingServiceServer) GetAllConsignments(ctx context.Context, req *GetAllReq) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllConsignments not implemented")
}
...
func _ShippingService_GetAllConsignments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAllReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShippingServiceServer).GetAllConsignments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/consignment.ShippingService/GetAllConsignments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingServiceServer).GetAllConsignments(ctx, req.(*GetAllReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ShippingService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAllConsignments",
			Handler:    _ShippingService_GetAllConsignments_Handler,
		},
	},
